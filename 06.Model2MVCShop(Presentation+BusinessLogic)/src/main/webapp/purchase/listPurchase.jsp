...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<tr class="ct_list_pop">
		...
		<c:set var="count" value="${count+1}"/>
			<a href="/getPurchase.do?tranNo=${purchase.tranNo }">${count}</a>
		</td>
		<td></td>
		<td align="left">
			<a href="/getUser.do?userId=user02">${purchase.buyer.userId }</a>
		</td>
		<td></td>
		...
		<c:if test="${purchase.tranCode == 2 }">
			현재 구입완료 상태 입니다.<a href="/updateTranCode.do?prodNo=${purchase.purchaseProd.prodNo }&tranCode=3">물건도착</a>
		</c:if>
